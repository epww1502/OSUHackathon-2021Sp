...
# Slack API 필요!
slack = "xoxb-1940285825253-1967173782768-iXMAsH5C3gp6PKVAd4dS6row" # Should input slack info
...
def balance_check():
    ...
    for ticker in pyupbit.get_tickers() :
        ...
        post_message(slack,"#stock", str(ticker) + ":" + str(balance) + " ")
        #time.sleep(0.1)
...
#post_message(slack,"#stock", upbit.get_balances())
